                ...
                <Col span={16} offset={1}>
                    <Card hoverable style = {{borderRadius: "25px"}} title = "User Information">
                        <Descriptions bordered labelStyle={{ width: '20%' }}>
                            <Descriptions.Item label="First Name " span={6}>{getFirstName()}</Descriptions.Item>
                            <Descriptions.Item label="Last Name " span={6}> {getLastName()}</Descriptions.Item>
                            <Descriptions.Item label="Age " span={6}>{localStorage.getItem("age") !== 0 ? localStorage.getItem("age") : <span>Не вказано</span>}</Descriptions.Item>
                            <Descriptions.Item label="Email" span={6}>{localStorage.getItem("email").length !== 0 && localStorage.getItem("email") !== 'null' ? localStorage.getItem("email") : <span>Не вказано</span>}</Descriptions.Item>
...

                            {
                                isAnySubscription() ?
                                    ...
                                    : <Col span={6} offset={8} align="center">
                                        <span align="center"><Card style={{ width: "500px" }}>
